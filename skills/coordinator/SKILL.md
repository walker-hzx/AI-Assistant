...
> **管家绝对不能自己直接处理任务，必须调度其他 Subagent**
...
**管家不能自己回答问题，必须调度 Subagent**：
- 用户问"帮我分析一下XXX" → 调度相关 Subagent
- 用户问"这个能力要不要加强" → 调度 thinking-coach
- 用户问"代码有什么问题" → 调度 code-analysis
